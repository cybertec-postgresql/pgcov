...
- [X] T054 [US2] Create order-independence test in internal/integration_test.go (run tests A→B and B→A, verify identical results)
- [X] T055 [US2] Create isolation test fixtures in testdata/isolation/ (tests that modify state)
- [X] T056 [US2] Verify test independence in integration tests (run same test twice, verify identical coverage)
...
- [X] T080 [P] Add comprehensive unit tests in internal/parser/parse_test.go (test parsing edge cases)
- [X] T081 [P] Add unit tests in internal/instrument/instrumenter_test.go (test instrumentation correctness)
- [X] T082 [P] Add unit tests in internal/database/tempdb_test.go (test database lifecycle)
- [X] T083 [P] Add unit tests in internal/coverage/collector_test.go (test signal aggregation)
- [X] T084 [P] Create edge case test fixtures in testdata/edge_cases/ (syntax errors, empty files, large files)
- [X] T085 [P] Create PL/pgSQL test fixtures in testdata/plpgsql/ (functions, procedures, triggers)
...
- [X] T088 [P] Add verbose logging throughout all layers (use --verbose flag)
- [ ] T089 [P] Optimize coverage data structure for large projects (benchmark 10k LOC)
- [X] T090 [P] Document CLI contract in docs/cli-contract.md (copy from specs/)
- [X] T091 [P] Create quickstart guide in docs/quickstart.md (copy from specs/)
- [X] T092 [P] Create examples in examples/ directory (simple project, CI integration)
